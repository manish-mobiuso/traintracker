...
//        [[UIActivityIndicatorView appearance] setFrame:CGRectMake(0.0f, 0.0f, 27.0f, 27.0f)];
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.mobiuso.traintracker" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("traintracker", withExtension: "momd")!
